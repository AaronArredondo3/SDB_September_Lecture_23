...
/* 
    ...
    - An array with multiple items need those items to be separated by a comma.
*/
...
/* 
    ...
    3. Each item, regardless of datatypes, are separated by a comma.
*/

let burritos = ['large', 2, true];
console.log(burritos); // [ 'large', 2, true ]

console.log(typeof burritos); // object, JS defines objects as a container that can hold multiple datatypes. So an Array is also an Object. JS starts the count at 0!
