...
console.log(`Spider Man lands on the ${structure}! He corners and confronts the thief! Spidy saves the day again!`);
...
console.log(`Final total after do while run: ${num}.`)
...
do {
    ...
    // After acct is activated (set to true), add 1 to acctNum variable to move to next acct
    acctNum++;
