...
// If using a straight return (one item is returning from a statement): we don't need to use use curly brackets
...
console.log(`sum equals ${sum} before the for loop.`) // sum equals 15 before the for loop.
...
/* 
    ...
    ^variable is any word we choose to use, iterableData is the name of nay iterable "thing"
